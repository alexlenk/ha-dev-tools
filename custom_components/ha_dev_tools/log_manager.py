...
class LogEntry:
    ...
    def __init__(self, timestamp: datetime, level: str, source: str, message: str, component: str = ""):
...
class LogManager:
    ...
    def _parse_log_content(self, content: str, source: str) -> List[LogEntry]:
        ...
        for line in lines:
            ...
            try:
                ...
                parts = line.split(' ', 3)
                if len(parts) >= 4:
                    # Simplified parsing - assumes format: YYYY-MM-DD HH:MM:SS LEVEL component: message
                    date_part = parts[0]
                    time_part = parts[1]
                    level = parts[2]
    ...
    def _apply_filters(self, entries: List[LogEntry], filters: LogFilters) -> List[LogEntry]:
        """
        ...
        if filters.search:
            ...
            filtered = [
                e for e in filtered 
                if search_lower in e.message.lower() or search_lower in e.component.lower()
            ]
