...
class FileManager:
    ...
    def __init__(self, hass: HomeAssistant, security_manager: SecurityManager) -> None:
        ...
        _LOGGER.info(
            "FileManager initialized for config directory: %s", self.config_dir
        )
    ...
    async def read_file(self, file_path: str) -> str:
        ...
        try:
            ...
            _LOGGER.debug(
                "Successfully read file: %s (%d bytes)", file_path, len(content)
            )
            return content
    ...
    async def write_file(
        ...
        try:
            ...
            _LOGGER.info(
                "Successfully wrote file: %s (%d bytes)", file_path, len(content)
            )
